        ...
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          ...
          <div className="hidden shrink-0 gap-2 md:flex">
            <Button
              ...
              className="disabled:pointer-events-auto hover:bg-primary hover:text-primary-foreground"
            >
            ...
            {items.map((item) => (
              ...
              >
                <div className="group rounded-xl cursor-pointer">
                  <div className="group relative h-full min-h-[27rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9] shadow-elegant hover:shadow-luxury transition-all duration-500">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="absolute h-full w-full object-cover object-center transition-transform duration-500 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 h-full bg-gradient-to-t from-luxury/90 via-luxury/40 to-transparent" />
